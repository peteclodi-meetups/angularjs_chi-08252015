...
angular.module('angular1xApp')
    .controller('Slide12HTTPController', ['$scope', '$controller', function($scope, $controller) {
        ...
        $scope.listItemsCache = [
            {id: 0, text: "Implements methods that support all of the standard Request Verbs", subItems: [{id: 0, text: "get, post, put, delete, head, patch, JSONP"}] },
            {id: 1, text: "Calls return a promise/deferred object that supports two calls to handle responses", subItems: [{id: 0, text: "success(...) and error(...)"}] }
        ];
